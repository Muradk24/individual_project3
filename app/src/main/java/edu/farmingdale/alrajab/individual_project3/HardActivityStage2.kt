...
class HardActivityStage2 : AppCompatActivity() {

    private var mediaPlayer: MediaPlayer? = null
    lateinit var binding: ActivityHardStage2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityHardStage2Binding.inflate(layoutInflater)
...
// after 1 click on loading the fucntion you need to click it again to play the anamation
    ...
    private fun success() {
        ...
        retrying?.setOnClickListener {
            builder.dismiss()
            startActivity(Intent(this,HardActivityStage3::class.java))
            finish()
        }
